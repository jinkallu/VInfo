...
export class CategoryApi {
     ...
     static async gettoolbox() {
          ...
          let msg;
          // const data=await Array.of(response.json());
          ...
          for (let itemprop of data.itemprops) {
               this.categoryProps.push(new ItemProp(itemprop.catitemid, itemprop.propid,itemprop.propname, itemprop.proptype, itemprop.propspec, itemprop.propdefval,itemprop.sortorder,itemprop.isrequired))
          }
     ...
     //      new CategoryItem('c7', 'i28', 'SaveFile', '/static/images/filesave.png', 1, 0),
     // ];
